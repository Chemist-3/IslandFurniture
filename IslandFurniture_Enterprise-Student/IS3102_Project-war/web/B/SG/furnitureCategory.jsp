...
<html> <!--<![endif]-->
    ...
    <body>
        <%
            ...
            System.out.println("List<Furniture> size:" + furnitures.size());
        %>
        <div class="body">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <ul class="products product-thumb-info-list" data-plugin-masonry>
                                <%
                                    // Loop through List to display all furnitures by category
                                    try {
                                    ...
                                    <span class="product-thumb-info">
                                        ...
                                        <span class="product-thumb-info-content">
                                            ...
                                            <%
                                                ...
                                                String displayPrice = "$" + df.format(furnitures.get(i).getPrice());
                                            %>
