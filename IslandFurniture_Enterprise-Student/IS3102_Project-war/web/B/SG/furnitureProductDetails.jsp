...
<html> <!--<![endif]-->
    ...
    <body>
        <%
            ...
            for (int i = 0; furnitures.size() > i; i++) {
                if (furnitures.get(i).getSKU().equals(sku)) {
                    name = furnitures.get(i).getName();
                    category = furnitures.get(i).getCategory();
                    imageURL = furnitures.get(i).getImageUrl();
                    ...
                    displayPrice = "$" + df.format(furnitures.get(i).getPrice());
                    break;
                } else {
                    continue;
                }
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <div class="product_meta">
                                        <span class="posted_in">Category: <a rel="tag" href="../../ECommerce_FurnitureCategoryServlet?cat=<%=categoryToURL%>"><%=category%></a></span>
                                    </div>
                                    <br/><br/>
