    ...
    <body>
        <script>
            ...
            function update(id) {
                ...
                // Sets percision to 1 decimal place for Math.round
                const precision = 10;
                
                // Since all numbers in JavaScript are already "double precision" (64-bit) floats, use parseFloat.
                // Math.round for rounding to set percision decimal place.
                itemPricingManagement.setPrice.value = Math.round(parseFloat($("#price" + id).val()) * precision) / precision;
