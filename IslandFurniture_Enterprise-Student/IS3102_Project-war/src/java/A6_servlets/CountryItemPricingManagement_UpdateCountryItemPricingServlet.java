...
public class CountryItemPricingManagement_UpdateCountryItemPricingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Modified for user input validation - decimal points
            else if ((BigDecimal.valueOf(Double.parseDouble(price)).scale() > 1) == true){
                response.sendRedirect("CountryItemPricingManagement_Servlet?errMsg=Price should not have more than 1 decimal point, please try again.");
            }
            else {
